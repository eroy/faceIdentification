...
import sergey.zhuravel.faceverification.MyApplication;
...
public class MxNetUtils {
    ...
    public static List<Float> getFeaturesList(Bitmap srcBitmap) {
        ...
        Log.e("verification time", String.valueOf(System.currentTimeMillis() - t));
    ...
    public static float[] listToArrayFloat(List<Float> list) {
        float[] arrayInt = new float[list.size()];
    ...
    public static float calCosineSimilarity(List<Float> listA,List<Float> listB) {
        float[] a = listToArrayFloat(listA);
        float[] b = listToArrayFloat(listB);
